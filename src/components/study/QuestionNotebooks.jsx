  ...
  return (
    <>
      <section className="summary-grid summary-grid--cadernos">
        <SummaryCard className="summary-card--cadernos-total" title="Cadernos" value={visibleNotebooks.length} description="Coleções ativas para organizar suas questões" icon={<svg viewBox="0 0 24 24" fill="none" role="img"><path d="M5.5 6.5A2.5 2.5 0 0 1 8 4h10.5v14.25A1.75 1.75 0 0 1 16.75 20H8A2.5 2.5 0 0 0 5.5 22V6.5Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" /><path d="M8.5 8.25h7M8.5 11.75h7M8.5 15.25h4.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>} />
        <SummaryCard className="summary-card--cadernos-questoes" title="Questões salvas" value={totalQuestions} description="Itens prontos para treino futuro" icon={<svg viewBox="0 0 24 24" fill="none" role="img"><path d="M7 4.75h7.75L19.25 9v10.25A2.75 2.75 0 0 1 16.5 22H7.5A2.75 2.75 0 0 1 4.75 19.25v-11.75A2.75 2.75 0 0 1 7.5 4.75Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" /><path d="M14.25 5.25v4.5h4.5M8.5 13.75h7M8.5 17.25h5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>} />
        <SummaryCard className="summary-card--cadernos-ativos" title="Cadernos ativos" value={activeBooks} description="Cadernos que já possuem questões" icon={<svg viewBox="0 0 24 24" fill="none" role="img"><path d="m6 12.5 3.5 3.5L18 7.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z" stroke="currentColor" strokeWidth="1.7" /></svg>} />
      </section>
      ...
      {editingQuestion ? <div className="plan-modal-overlay"><div className="plan-modal notebook-edit-modal notebook-question-modal" role="dialog" aria-modal="true" aria-labelledby="question-edit-title" onClick={(e) => e.stopPropagation()}>
      ...
      {questionOpen ? <div className="plan-modal-overlay"><div className="plan-modal notebook-edit-modal notebook-question-modal" role="dialog" aria-modal="true" aria-labelledby="question-create-title" onClick={(e) => e.stopPropagation()}>
